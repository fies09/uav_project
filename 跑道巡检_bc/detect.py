...
def mainfundo(image_current,image_origin):
    tag, score, box, rectangle_img = detection_2(image_current, image_origin,
                                                 size=config.img_information['size'],
                                                 threshold=config.img_information['threshold'])
...
if __name__ == '__main__':
    ...
    img_current_path = config.img_information['img_path'] + config.img_information['img_current_name']
    img_origin_path = config.img_information['img_path'] + config.img_information['img_origin_name']
